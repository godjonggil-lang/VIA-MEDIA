...
export const metadata = {
  title: '소개 | VIA MEDIA',
  description: 'VIA MEDIA의 철학과 운영 방식을 소개합니다.',
}
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <p className="font-sans text-gray-700 leading-relaxed">
            VIA MEDIA는 하나의 의제에 대해 진보와 보수의 시각을 나란히 배치합니다. 독자가
        ...
        <section className="mb-12">
          ...
          <p className="font-sans text-gray-700 leading-relaxed">
            VIA MEDIA는 독자가 특정 진영의 논리에 갇히지 않도록, 매 기사마다 반대 시각을
        ...
        <section className="bg-gray-50 border border-gray-200 p-8">
          ...
          <p className="font-sans text-sm text-gray-700 leading-relaxed mb-3">
            VIA MEDIA는 외부 광고 없이 독자의 구독과 후원으로 운영됩니다. 어떤 정당, 기업,
