...
export default async function AgendaPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="mb-10">
        <h1 className="font-serif font-black text-4xl text-gray-900 mb-3">아젠다</h1>
        <p className="font-sans text-gray-600">
          현재 VIA MEDIA가 다루는 주요 의제들입니다. 각 아젠다마다 진보와 보수의 시각을 함께
          읽어보세요.
        </p>
      </div>
      ...
      {agendas.length === 0 ? (
        ...
        <AgendaPageClient agendas={agendas} articles={articles} />
      )}
    </div>
  )
}
